...
Редактор будет обладать самым минимальным функционалом: карандаш, кисть, ластик, рисование простейших фигур (линия, прямоугольник, овал),
выбор цвета. Выбор цвета как из минимального набора в цветовой панели, так и из расширенного набора цветов.
